...
import py_compile
py_compile.compile('study_room.py')
...
class Sprite:
    ...
    def render(self,index):
        ...
        if self.allow !=7:
            ...
            if self.allow!=1 and self.allow!=3:
                ...
                if 400<cur[0]<550 and 192<cur[1]<242:              
                    pygame.draw.rect(window,white,[400,192,220,50])
                    text_display("Put mosquito nets on the Bed",black,100,-80,"verysmall")        
...
#loading room
img_room=pygame.image.load("images/images/room_bed.png").convert_alpha()
...
#Bed net image
bed_net=pygame.image.load("images/images/bednet.png").convert_alpha()
    ...
    for event in pygame.event.get():
        ...
        if (event.type==pygame.KEYDOWN):
            ...
            if (event.key==pygame.K_LEFT):
                ...
                Sprite1.images=[]
                #loading an image into a variable
                img_char1=pygame.image.load("images/images/images/l1.png").convert_alpha()
            ...
            if cue==7:    
                ...
                while 1:
                    if time()-last_time > 3:
                        ...
                        print "\nentered loop\n"                   
                        text_display("Rs 2500 added to wallet for completing all objectives",white,-3,-165,"small")
                        pygame.display.update()
